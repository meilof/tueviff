...
"""Methods for pseudo-random secret sharing. Normal Shamir sharing
...
def prss_double(n, j, field1, field2, prfs, key):

    rep_shares = random_replicated_sharing(j, prfs, key)
    return convert_replicated_shamir(n, j, field1, rep_shares), convert_replicated_shamir(n, j, field2, rep_shares)
